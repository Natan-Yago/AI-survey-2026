...
export const surveyQuestions: Question[] = [
  ...
  { section: 'בשלות ואימוץ AI', type: 'matrix-single',
    ...
    question: 'באיזו מידה אתה/את מעריך/ה ש-AI ישבש או ישנה באופן מהותי את התחומים הבאים בשלוש השנים הקרובות?',
    instructions: 'בחר/י תשובה אחת בכל שורה.',
    ...
    columns: ['כלל לא','במידה מועטה','במידה בינונית','במידה גבוהה','במידה גבוהה מאוד'] },
  ...
  { section: 'השקעות, תשתיות וערך', type: 'matrix-column-single',
    title: 'צריכת טוקנים',
    question: 'להערכתך, מהו היקף צריכת הטוקנים החודשי של הארגון כיום, ומהו ההיקף הצפוי בעוד שלוש שנים?',
    instructions: 'יש להתייחס לסך צריכת הטוקנים בארגון, כולל input ו-output tokens, באפליקציות AI, כלי GenAI, מודלים, סוכנים ותהליכי inference. טוקן הוא יחידת מדידה לצריכת AI, המשקפת גם שימוש וגם עלות. גידול בצריכת טוקנים עשוי להעיד על הרחבת אימוץ AI, אך גם על צורך בניהול כלכלי וארכיטקטוני מתקדם יותר.',
    rows: ['פחות מ-10 מיליון טוקנים בחודש','10–100 מיליון טוקנים בחודש','100 מיליון – 1 מיליארד טוקנים בחודש','1–10 מיליארד טוקנים בחודש','מעל 10 מיליארד טוקנים בחודש','לא יודעים / לא מודדים כיום'],
    columns: ['כיום','בעוד 3 שנים'] },
  { section: 'השקעות, תשתיות וערך', type: 'single',
    title: 'ניהול כלכלת הטוקנים',
    question: 'איזו מהאפשרויות הבאות מתארת בצורה הטובה ביותר את האופן שבו הארגון מנהל כיום את צריכת הטוקנים ועלויות ה-AI?',
    instructions: 'בחר/י אפשרות אחת.',
    options: ['איננו מודדים כיום צריכת טוקנים או עלויות AI באופן שיטתי.','קיימת מדידה בסיסית של שימוש ועלויות, בעיקר ברמת ספקים או כלים.','אנו מנטרים צריכת טוקנים לפי יחידות, שימושים או אפליקציות מרכזיות.','אנו מנהלים כלכלת טוקנים כחלק ממדיניות FinOps / AI cost management, כולל אופטימיזציה של prompts, context, מודלים ועלויות.','צריכת טוקנים מנוהלת כמדד אסטרטגי, עם חיבור לערך עסקי, תקצוב, תעדוף יוזמות והחלטות תשתית.'] },
  ...
  { section: 'טאלנט וטכנולוגיות מתקדמות', type: 'single',
    ...
    instructions: 'עובדים לא טכנולוגים הם עובדים שאינם חלק מיחידת הטכנולוגיה/IT של הארגון. בחר/י את האפשרות המתאימה ביותר.',
  ...
  { section: 'טאלנט וטכנולוגיות מתקדמות', type: 'single',
    ...
    question: 'באיזו מידה הארגון משתמש כיום ב-Generative AI (לדוגמה, צ׳אטבוטים או יישומים ליצירת תוכן) בפעילותו?',
    instructions: 'בחר/י אפשרות אחת.',
